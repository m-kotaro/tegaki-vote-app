    ...
    votes: [
      {
        ...
        reason: "候補者リストの『まるまる』と一致（モック）",
        created_at: "2026-04-01T12:00:00Z",
        // モックなのでダミー画像（プレースホルダ画像サービス）。実在の投票画像ではない。
        image_url: "https://placehold.co/300x200?text=seed-1",
      },
      {
        vote_id: "seed-2",
        matched_candidate: "まるまる",
        ...
        image_url: "https://placehold.co/300x200?text=seed-2",
      },
      {
        vote_id: "seed-3",
        matched_candidate: "まるまる",
        ...
        image_url: "https://placehold.co/300x200?text=seed-3",
      },
      {
        vote_id: "seed-4",
        ...
        reason: "候補者リストの『バツバツ』と一致（モック）",
        created_at: "2026-04-01T12:03:00Z",
        image_url: "https://placehold.co/300x200?text=seed-4",
      },
      {
        vote_id: "seed-5",
        matched_candidate: "三角三角",
        is_valid: true,
        recognized_text: "さんかくさんかく",
        reason: "候補者リストの『三角三角』と一致（モック）",
        created_at: "2026-04-01T12:04:00Z",
        image_url: "https://placehold.co/300x200?text=seed-5",
      },
      {
        vote_id: "seed-6",
        ...
        is_valid: false,
        recognized_text: "しかく",
        reason: "いずれの候補者とも一致しなかった（モック）",
        created_at: "2026-04-01T12:05:00Z",
        // 無効票だが画像あり（/invalid で「画像あり」表示を確認するためのダミー）。
        image_url: "https://placehold.co/300x200?text=seed-6",
      },
      {
        vote_id: "seed-7",
        matched_candidate: null,
        ...
        reason: "判読不能（confidence が閾値未満）（モック）",
        created_at: "2026-04-01T12:06:00Z",
        // presign 失敗相当。/invalid で「画像なし」プレースホルダ表示を確認するため null。
        image_url: null,
      },
    ],
  },
